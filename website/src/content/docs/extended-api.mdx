...
Use `createCustomSection` when you specifically want image-backed custom emoji with required `imageUrl` values. Use `createSupplementalSection` for the broader supplemental-item model.
